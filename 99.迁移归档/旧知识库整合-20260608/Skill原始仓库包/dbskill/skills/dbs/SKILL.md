...
| 明确提到 Codex、Codex、AGENTS.md、AGENTS.md、skill bridge、工作台迁移、双端统一，或说“我的 Agent 工作台很乱”“帮我统一 Codex 和 Codex” | `/dbs-agent-migration` | Agent 工作台迁移，整理规则文件、真源、命名与 Codex / Codex 双端 bridge |
...
- 用户的需求不在路由表范围内 → 直接说：「这个超出我的能力范围。我能帮你的是：多角色讨论、商业诊断、对标分析、内容创作诊断、开头优化、小红书标题公式、慢方法诊断、执行力诊断、概念拆解、AI 写作检测、目标清晰化、好问题生成、交互式学习。」

...
> 2026-06-08 更新：本地 Obsidian 运行时唯一记忆系统为 `02-记忆系统/`，旧 `C-记忆核心` 路径只作为历史 New Drive 术语。
...
- **五大板块结构**：`A-系统基座 / B-参考资料 / 02-记忆系统 / D-内容创作 / E-产出交付` 都在 New Drive 上
